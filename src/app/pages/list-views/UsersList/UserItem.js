...
const UserItem = ({userData, DeleteFun}) => {
            ...
            <Stack direction={"row"} alignItems={"center"} sx={{p: theme => theme.spacing(2, 1)}}>
                ...
                >
                    <Stack direction={'row'} alignItems={'center'}>
                        ...
                        <Item>
                            <Typography variant={"h6"} mb={.5}>{`${userData.full_name}`}</Typography>
                ...
                >
                     <Link  style={{color: "#fff"}} to={`/list-views/users/edit/${userData.id}`}>
